...
const PreGeneratedUrls = () => {
  ...
  const handleGenerateUrlTagChange = (e) =>
    setGenerateUrlTag(parseInt(e.target.value));
          ...
          <TableBody>
            {urls.map((url, index) => (
              <TableRow key={url.url_id}>
                ...
                <TableCell>
                  <QRCode value={url.short_url} size={60} />{" "}
                  {/* QR Code for each URL */}
                </TableCell>
                <TableCell>
                  <Button
                    variant="contained"
                  ...
                  <Button
                    ...
                    color="success"
                    onClick={() =>
                      handleCopyToClipboard(url.short_url, url.url_id)
                    }
                  >
                    <FaCopy />
                  </Button>
